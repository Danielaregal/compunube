...
#--------------------------------------------------- Pregunta 1 : Implementación de Cluster VagrantVM3 -----------------------------------------------------------
...
# Remoción de archivo lxdconfig.yaml, a fin de evitar sobreescribir el mismo cuando se aprovisiona la máquina virtual VagrantVM3 más de una vez.  
...
# Creación de archivo lxcconfig extensión yaml, con la configuración seleccionada para la unión del nodo al Cluster, en la máquina virtual VagrantVM3.
...
#------------------------------------------------ Pregunta 2 : Aprovisionamiento de Contenedores - Web2 -------------------------------------------------------

echo "Pregunta 2: Aprovisionamiento de Web2"


# Lanzamiento de contenedor "web2" usando la imagen de Ubuntu 20.04 en la Máquina Virtual VagrantVM3. 
# Se agrega el comando < /dev/null para que durante el lanzamiento del contenedor no lo reconozca como un YAML.  
lxc launch ubuntu:20.04 web2 --target VagrantVM3 < /dev/null
...
# Remoción de archivo index.html, a fin de evitar sobreescribir el mismo cuando se aprovisiona la máquina virtual VagrantVM3 más de una vez.
sudo rm index.html
...
# Se envia el archivo index.html creado en la maquina virtual VagrantVM3 al contenedor en el directorio /var/www/html/
...
#----------------------------------------------- Pregunta 2 : Aprovisionamiento de Contenedores - Web2bakup ---------------------------------------------------


echo "Pregunta 2: Aprovisionamiento de Web2 - Backup"


# Lanzamiento de contenedor "web2backup" usando la imagen de Ubuntu 20.04 en la Máquina Virtual VagrantVM3. 
# Se agrega el comando < /dev/null para que durante el lanzamiento del contenedor no lo reconozca como un YAML.  
lxc launch ubuntu:20.04 web2backup --target VagrantVM3 < /dev/null
